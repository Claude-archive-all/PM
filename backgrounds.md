# Background Reference Library

Этот файл — индекс фоновых референс-изображений для проекта PM.
Храни его в корне репозитория `Claude-archive-all/PM` (`main` ветка).
Сами изображения лежат в папке `El/Bg ref/`.

Формат записи:
```
### <filename>
<Описание: цвета, структура/паттерн, композиция, настроение, освещение>
...
### 2.webp
The image depicts a futuristic, vibrant esports arena, likely for a major tournament. The scene is dominated by a large, central stage area in the foreground. This stage is dark, with a prominent, glowing orange symbol etched into its surface, shaped like a stylized "PM" or possibly a shield with a prominent central element. The stage is bordered by illuminated lines, also in orange, that highlight its polygonal shape.
Rising from the center of the stage is a monumental trophy stand. The stand is dark gray and angular, with sharp lines tapering upwards. Perched atop this stand is the grand prize trophy itself. It's a large, ornate, golden emblem, circular in design, with intricate details that suggest rays of light or a stylized sun at its core. The trophy is exceptionally bright and reflects light, signifying its importance.
Surrounding the stage is a massive stadium, designed with tiered seating that arcs around the performance area. The stadium's architecture is modern and sleek. The seating sections are illuminated with vibrant neon lights, primarily in shades of electric purple and blue, with some accents of orange. The purple lights run along the upper edges of the stadium, creating a striking contrast with the darker structure. The blue lights are positioned lower, near the arena floor, giving the impression of a grand, energetic atmosphere.
In the background, beyond the stadium, a city skyline is visible under a dark, twilight sky. The city buildings are tall and illuminated, with some appearing to be digital billboards displaying graphics, including one on the right side of the image that shows a stylized dragon or mythical creature with glowing red eyes. The overall color palette is a dramatic combination of deep blues and purples, punctuated by the bright oranges and golds of the stage, trophy, and some architectural details.
The composition is wide and cinematic, placing the viewer at the entrance to the arena, looking towards the stage and the heart of the event. The depth of field draws the eye from the immediate foreground of the stage, past the trophy, and out to the expansive stadium and the distant city. The lighting is dramatic, with strong highlights on the trophy and neon glows illuminating the arena, creating a sense of anticipation and excitement. Subtle details include the texture on the stadium's upper rim that resembles cracked earth or circuitry, and the faint reflections on the stage surface. The branding "M5" is visible on banners within the stadium, further cementing its identity as a significant esports event.



### 3.webp
The image depicts a futuristic cityscape with an elevated race track winding through it. The race track dominates the foreground, curving dynamically to the right. It is constructed from metallic, segmented panels with glowing yellow accents. The sides of the track are lined with a transparent, blue-tinted material, possibly a barrier or tunnel, punctuated by vertical glowing blue lights.
In the mid-ground and background, a sprawling city rises with sleek, modern architecture. Skyscrapers with pointed roofs and geometric designs are visible. The sky is a bright, clear blue with a prominent sun casting a lens flare effect, creating a rainbow-like arc. Several futuristic airships, bulbous and silver, are suspended in the sky, along with what appear to be smaller aircraft in the distance.
To the right of the track, a tall, cylindrical white tower stands. It has a rounded top with a pink accent and a large, rectangular screen mounted on its side. The screen displays a close-up image of two cartoonish, muscular characters in blue outfits, with the text "BLUE FALCONS" visible. This suggests a sporting event or broadcast.
The overall color palette is bright and vibrant, dominated by blues, silvers, whites, and yellows, with touches of pink and purple in the distant city. The composition uses a strong sense of perspective, drawing the viewer's eye along the curving track and into the depth of the city. The lighting is bright and airy, contributing to a sense of optimism and advanced technology. The image has a clean, high-definition, CG rendered aesthetic, likely from a video game or animated production.



### 4.webp
The image depicts a dynamic nighttime scene of a modern cityscape with an emphasis on motion and light. The primary focus is a highway or elevated road, rendered with a strong sense of speed due to motion blur. Streaks of white and electric blue light, representing vehicle headlights and taillights, race along the road's surface and the surrounding infrastructure.
Dominating the background, slightly to the left of the center, are two distinctive, tall, futuristic towers that appear to be illuminated from within, emitting a bright white and light blue glow. These structures have a complex, layered design, resembling organic forms or perhaps stylized trees with wide, flat canopies at different levels. They are silhouetted against a deep, dark blue sky, which is a consistent color throughout the upper portion of the image.
The road itself curves gracefully into the distance, with illuminated lane markers and reflective surfaces. To the left of the road, a large, sweeping architectural element, likely part of a bridge or overpass, curves overhead, also highlighted with white light along its edges. The composition uses a low-angle perspective, placing the viewer on the road, looking forward and slightly upwards. This perspective, combined with the light trails, creates an immersive and futuristic atmosphere, suggesting rapid transit through a technologically advanced urban environment. The overall color palette is dominated by deep blues, bright whites, and vibrant electric blues, evoking a sense of technology, speed, and nighttime activity. There are no visible people in the image.
...
### 7.webp
The image depicts a futuristic cityscape at dusk or night, illuminated by vibrant neon lights. The foreground features a circular platform with a metallic, slightly iridescent surface, reminiscent of a stage or landing pad. This platform has a subtle blue glow around its edge and a stylized 'PM' logo in its center.
The main focus of the scene is the array of tall, sleek skyscrapers that dominate the background. These buildings are rendered in shades of purple, blue, and white, with sharp, angular designs and pointed spires. Many of them are adorned with large, glowing signs and digital displays. Notable signs include "BATTLE" in bright pink on a cylindrical tower, angled building. Another prominent building on the right has a large, multi-paneled screen displaying colorful graphics and texts.
...
---
### 10.webp
A futuristic stage with a guitar-shaped structure on the left and a circular speaker-like structure on the right. The stage is illuminated with purple and blue lights, creating a vibrant and energetic atmosphere. The floor is reflective, mirroring the lights and structures above. The overall composition is symmetrical, with the guitar and speaker structures acting as focal points on either side of the stage.
---
### 11.webp
A dark purple background is filled with diagonal, jagged lines that resemble lightning bolts. These lines are colored with a gradient that transitions from a bright teal on the left to a vibrant blue on the right. The lines are evenly spaced and curve slightly, creating a dynamic and energetic visual effect.
---
### 12.webp
